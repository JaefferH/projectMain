...
export function HeroQuote() {
  ...
  return (
    <>
      <figure className="mt-3 sm:mt-4 min-h-[6rem] sm:min-h-[8.5rem] relative">
        <AnimatePresence mode="wait">
          <motion.blockquote
            ...
            className="cursor-pointer group rounded-2xl p-4 sm:p-5 bg-black/75 hover:bg-black/85 border border-[#6ee7b7]/50 hover:border-[#6ee7b7] backdrop-blur-md transition-all shadow-[0_8px_30px_rgba(0,0,0,0.7)] hover:shadow-[0_0_25px_rgba(110,231,183,0.4)] inline-block text-left w-full sm:w-auto"
          >
            <div className="flex items-center gap-2 mb-1.5 text-xs text-[#6ee7b7] font-extrabold">
            ...
            <p className="mt-1.5 font-display text-base sm:text-2xl font-extrabold text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.95)] group-hover:text-[#6ee7b7] transition-colors leading-snug">
              {q.text[lang]}
            </p>
