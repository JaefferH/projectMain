        ...
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-28 sm:pb-24 sm:pt-36 sm:px-6">
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <p className="inline-flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-extrabold uppercase tracking-[0.16em] sm:tracking-[0.22em] text-[#6ee7b7] bg-black/80 backdrop-blur-md px-3.5 py-1.5 sm:px-4 sm:py-1.5 rounded-full border border-[#6ee7b7]/40 shadow-lg">
            ...
            <div className="space-y-2.5 sm:space-y-3">
              {lang === "ar" ? (
                /* Arabic Title */
                <h1 dir="rtl" lang="ar" className="font-arabic text-3xl sm:text-6xl md:text-7xl font-extrabold text-[#6ee7b7] leading-relaxed drop-shadow-[0_4px_25px_rgba(0,0,0,0.95)] sm:drop-shadow-[0_0_30px_rgba(110,231,183,0.7)] tracking-wide">
                  مَسْجِدُ وَمَدْرَسَةُ الإِمَامِ حَسَنٍ
                </h1>
              ) : lang === "am" ? (
                /* Amharic Title */
                <h1 className="font-display text-3xl sm:text-6xl md:text-7xl font-extrabold leading-[1.15] tracking-tight drop-shadow-[0_8px_30px_rgba(0,0,0,0.95)]">
                  <span className="text-white sm:text-transparent sm:bg-clip-text sm:bg-gradient-to-r sm:from-white sm:via-[#a7f3d0] sm:to-[#34d399] drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">
                    አል ኢማም ሀሰን መስጂድ እና መድረሳ
                  </span>
                </h1>
              ) : (
                /* English Title */
                <h1 className="font-display text-3xl sm:text-6xl md:text-7xl font-extrabold leading-[1.1] tracking-tight drop-shadow-[0_8px_30px_rgba(0,0,0,0.95)]">
                  <span className="text-white sm:text-transparent sm:bg-clip-text sm:bg-gradient-to-r sm:from-white sm:via-[#a7f3d0] sm:to-[#34d399] drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">
              ...
              {/* Sub-Crest Badge */}
              <div className="pt-1">
                <span className="inline-flex items-center gap-2 px-3.5 py-1.5 sm:px-5 sm:py-2.5 rounded-full bg-[#021f17] border-2 border-[#fbbf24] text-[#fef08a] text-[11px] sm:text-sm font-black uppercase tracking-[0.14em] sm:tracking-[0.18em] shadow-[0_0_25px_rgba(251,191,36,0.6)] backdrop-blur-md font-arabic max-w-full">
            ...
            <div className="pt-3 sm:pt-4 flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
              <a
                href="#contact"
                className="w-full sm:w-auto text-center rounded-xl bg-gradient-to-r from-[#6ee7b7] via-[#34d399] to-[#10b981] hover:from-[#a7f3d0] hover:to-[#34d399] text-[#021a12] px-8 py-3.5 text-sm sm:text-base font-extrabold shadow-[0_0_25px_rgba(110,231,183,0.45)] transition-all hover:scale-105 active:scale-95 cursor-pointer"
              >
                {t("hero.cta1")} &rarr;
              </a>
              <a
                href="#programs"
                className="w-full sm:w-auto text-center rounded-xl bg-black/75 sm:bg-black/60 hover:bg-black/80 text-white border border-[#6ee7b7]/40 px-8 py-3.5 text-sm sm:text-base font-bold backdrop-blur-md transition-all hover:scale-105 cursor-pointer shadow-lg"
              >
                {t("hero.cta2")}
              </a>
            </div>
